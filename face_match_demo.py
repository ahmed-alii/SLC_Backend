...
pnet, rnet, onet = create_mtcnn(sess, "align")
...
img1 = cv2.imread('Record/test3.jpg')
# img2 = cv2.imread('Record/66.jpg')
#
# distance = compare2face(img1, img2)
# print(distance)
getFace(img1)

# threshold = 1.2  # set yourself to meet your requirement
#
# if distance ==-1:
#     print("Matching Result:  Invalid Images")
# elif distance<= threshold:
#      print("Matching Result:  same person")
# else:
